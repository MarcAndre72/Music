    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        ...
        >
          <i
            class="fa"
            :class="{ 'fa-play': !isSongPlaying, 'fa-pause': isSongPlaying }"
          ></i>
        </button>
...
export default {
  ...
  computed: {
    ...
    // HERE   usePlayerStore().playing
    isSongPlaying() {
      return usePlayerStore().playing;
    },
  },
  ...
  // HERE
  toggleSong() {
    console.log("toggleSong called");
    const playerStore = usePlayerStore();
    if (playerStore.playing) {
      playerStore.sound.pause();
    } else {
